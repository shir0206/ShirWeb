export const slides = [
  {
    ...
    description: [
      ...
      "When the app *detects* that the user is near a point of interest, it recommends reading more detailed information about that point.",
  ...
  },
  {
    ...
    description: [
      ...
      "**Search** images by *keywords & tags*.",
      ...
      "The most challenging concept was to represent the image cards **responsively** so that the amount of columns would be updated according to the screen width.",
    ],
  ...
  },
  {
    name: "TropiX",
    description: [
      "TropiX is a **mobile app** game, inspired by Tic-Tac-Toe, and designed for `Android` devices.",
